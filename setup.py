...
setup(
  name = 'topsis-Ashish-102117164',         # How you named your package folder (MyLib)
  packages = ['topsis-Ashish-102117164'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Topsis python package',   # Give a short description about your library
